...
const Introduction = () => {
  ...
  const handleNext = () => {
    if (isFormValid()) {
      // Save all onboarding data to context + localStorage
      saveOnboardingData({
  ...
  return (
    <div className="h-[812px]">
      ...
      <div className="ml-8 mt-4">
        <h5 className="font-medium text-[14px] text-[#303030]">Work Email</h5>
        <input
          type="text"
          name="workEmail"
      ...
      <div className="ml-8 mt-4">
        <h5 className="font-medium text-[14px] text-[#303030]">Phone Number</h5>
        <input
          type="text"
          name="phoneNumber"
